...
# --- РАБОТА С НАСТРОЙКАМИ В БД ---
def init_db():
    conn = sqlite3.connect('kgbmkasa_main.db', timeout=10)
    c = conn.cursor()
    # Включаем WAL режим для предотвращения блокировок базы при многопоточности
...
def subscription_markup():
    ...
    markup.add(
        types.InlineKeyboardButton("🔗 Подписаться", url="[https://t.me/BMKASSA24](https://t.me/BMKASSA24)"),
...
def referrals_menu(msg):
    ...
    ref_link = f"[https://t.me/](https://t.me/){BOT_USERNAME}?start={msg.chat.id}"
